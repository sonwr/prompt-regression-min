...
class PromptRegressionCliTests(unittest.TestCase):
    ...
    def test_readme_mentions_priority_rank_triage_card_example(self) -> None:
        readme = README_PATH.read_text(encoding="utf-8")

        self.assertIn("examples/reviewer_queue_priority_rank_triage_card.md", readme)
        self.assertTrue((ROOT / "examples" / "reviewer_queue_priority_rank_triage_card.md").exists())

    def test_readme_mentions_runner_up_note_example(self) -> None:
        readme = README_PATH.read_text(encoding="utf-8")

        self.assertIn("examples/reviewer_queue_runner_up_note.md", readme)
        self.assertTrue((ROOT / "examples" / "reviewer_queue_runner_up_note.md").exists())

    def test_readme_mentions_report_bundle_name_note_example(self) -> None:
        readme = README_PATH.read_text(encoding="utf-8")

        self.assertIn("examples/reviewer_queue_report_bundle_name_note.md", readme)
        self.assertTrue((ROOT / "examples" / "reviewer_queue_report_bundle_name_note.md").exists())

    def test_readme_mentions_report_bundle_handoff_example(self) -> None:
        readme = README_PATH.read_text(encoding="utf-8")

        self.assertIn("examples/reviewer_queue_report_bundle_handoff.md", readme)
        self.assertTrue((ROOT / "examples" / "reviewer_queue_report_bundle_handoff.md").exists())

    def test_readme_mentions_priority_rank_release_gate_example(self) -> None:
        readme = README_PATH.read_text(encoding="utf-8")

        self.assertIn("examples/reviewer_queue_priority_rank_release_gate.md", readme)
        self.assertTrue((ROOT / "examples" / "reviewer_queue_priority_rank_release_gate.md").exists())

    def test_readme_mentions_priority_rank_hold_note_example(self) -> None:
        readme = README_PATH.read_text(encoding="utf-8")

        self.assertIn("examples/reviewer_queue_priority_rank_hold_note.md", readme)
        self.assertTrue((ROOT / "examples" / "reviewer_queue_priority_rank_hold_note.md").exists())

    def test_readme_mentions_priority_rank_hold_examples(self) -> None:
        readme = README_PATH.read_text(encoding="utf-8")

        self.assertIn("examples/reviewer_queue_priority_rank_hold_examples.md", readme)
        self.assertTrue((ROOT / "examples" / "reviewer_queue_priority_rank_hold_examples.md").exists())

    def test_readme_mentions_dual_lane_status_line_example(self) -> None:
        readme = README_PATH.read_text(encoding="utf-8")

        self.assertIn("examples/reviewer_queue_dual_lane_status_line.md", readme)
        self.assertTrue((ROOT / "examples" / "reviewer_queue_dual_lane_status_line.md").exists())

    def test_readme_mentions_priority_rank_owner_ready_bridge_example(self) -> None:
        readme = README_PATH.read_text(encoding="utf-8")

        self.assertIn("examples/reviewer_queue_priority_rank_owner_ready_bridge.md", readme)
        self.assertTrue((ROOT / "examples" / "reviewer_queue_priority_rank_owner_ready_bridge.md").exists())

    def test_readme_mentions_owner_status_ready_check_example(self) -> None:
        readme = README_PATH.read_text(encoding="utf-8")

        self.assertIn("examples/reviewer_queue_owner_status_ready_check.md", readme)
        self.assertTrue((ROOT / "examples" / "reviewer_queue_owner_status_ready_check.md").exists())

    def test_readme_mentions_small_batch_handoff_example(self) -> None:
        readme = README_PATH.read_text(encoding="utf-8")

        self.assertIn("examples/reviewer_queue_small_batch_handoff.md", readme)
        self.assertTrue((ROOT / "examples" / "reviewer_queue_small_batch_handoff.md").exists())

    def test_readme_mentions_validate_then_share_note_example(self) -> None:
        readme = README_PATH.read_text(encoding="utf-8")

        self.assertIn("examples/reviewer_queue_validate_then_share_note.md", readme)
        self.assertTrue((ROOT / "examples" / "reviewer_queue_validate_then_share_note.md").exists())

    def test_readme_mentions_scope_vs_skip_note_example(self) -> None:
        readme = README_PATH.read_text(encoding="utf-8")

        self.assertIn("examples/reviewer_queue_scope_vs_skip_note.md", readme)
        self.assertTrue((ROOT / "examples" / "reviewer_queue_scope_vs_skip_note.md").exists())

    def test_readme_mentions_priority_rank_queue_share_status_example(self) -> None:
        readme = README_PATH.read_text(encoding="utf-8")
    ...
    def test_readme_mentions_output_slug_note(self) -> None:
        ...
        self.assertIn("docs/CLI_SUMMARY_OUTPUT_SLUG_NOTE.md", readme)
        self.assertTrue((ROOT / "docs" / "CLI_SUMMARY_OUTPUT_SLUG_NOTE.md").exists())

    def test_readme_mentions_output_slug_bundle_example(self) -> None:
        readme = README_PATH.read_text(encoding="utf-8")

        self.assertIn("examples/reviewer_queue_output_slug_bundle_note.md", readme)
        self.assertTrue((ROOT / "examples" / "reviewer_queue_output_slug_bundle_note.md").exists())

    def test_readme_mentions_priority_rank_scope_tiebreak_example(self) -> None:
        readme = README_PATH.read_text(encoding="utf-8")
    ...
    def test_readme_mentions_next_focus_tie_summary_example(self) -> None:
        readme = README_PATH.read_text(encoding="utf-8")

        self.assertIn("examples/reviewer_queue_next_focus_tie_summary.md", readme)
        self.assertTrue((ROOT / "examples" / "reviewer_queue_next_focus_tie_summary.md").exists())

    def test_readme_mentions_queue_share_decision_card_example(self) -> None:
        readme = README_PATH.read_text(encoding="utf-8")

        self.assertIn("examples/reviewer_queue_queue_share_decision_card.md", readme)
        self.assertTrue((ROOT / "examples" / "reviewer_queue_queue_share_decision_card.md").exists())

    def test_readme_mentions_source_case_rate_note_example(self) -> None:
        readme = README_PATH.read_text(encoding="utf-8")

        self.assertIn("examples/reviewer_queue_source_case_rate_note.md", readme)
        self.assertTrue((ROOT / "examples" / "reviewer_queue_source_case_rate_note.md").exists())
    ...
    def test_summary_markdown_stdout_word_count_range_fixture_surfaces_regression_id(self) -> None:
        ...
        self.assertIn("- Reviewer queue group queue shares: fix_regressions=100.00%", markdown)
        self.assertIn("- Reviewer queue mix summary: fix_regressions=2 case(s)/100.00% queue share/100.00% active-case rate/100.00% source-case rate", markdown)
    ...
    def test_summary_pr_comment_includes_changed_ids_and_rate_for_reviewer_triage(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertIn("- Reviewer queue group queue shares: fix_regressions=100.00%", pr_comment)
            self.assertIn("- Reviewer queue mix summary: fix_regressions=1 case(s)/100.00% queue share/50.00% active-case rate/50.00% source-case rate", pr_comment)
    ...
    def test_summary_pr_comment_surfaces_tied_largest_group_labels(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertIn("- Reviewer queue group queue shares: fix_regressions=50.00%, watch_unchanged_fails=50.00%", pr_comment)
...
if __name__ == "__main__":
    ...
    def test_readme_links_report_bundle_handoff_example(self) -> None:
        repo_root = ROOT
        readme = (repo_root / "README.md").read_text(encoding="utf-8")
        example = repo_root / "examples" / "reviewer_queue_report_bundle_handoff.md"

        self.assertTrue(example.exists())
        self.assertIn("examples/reviewer_queue_report_bundle_handoff.md", readme)
        self.assertIn("shared artifact basename", example.read_text(encoding="utf-8"))

    def test_readme_links_stable_bundle_handoff_example(self) -> None:
        repo_root = ROOT
        readme = (repo_root / "README.md").read_text(encoding="utf-8")
        example = repo_root / "examples" / "reviewer_queue_stable_bundle_handoff.md"

        self.assertTrue(example.exists())
        self.assertIn("examples/reviewer_queue_stable_bundle_handoff.md", readme)
        self.assertIn("shared report bundle basename", example.read_text(encoding="utf-8"))
