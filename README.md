...
Those PR-comment snapshots keep the same schema marker and deterministic stable/regression ids as the markdown/JSON artifacts, so reviewers can paste the note without reformatting CI output.
